...
export function BrickWall() {
  ...
  useEffect(() => {
    ...
    /* Ждём шрифты, как hero и общая моторика: если создать триггер раньше,
       он посчитает старт по вёрстке без пин-отступа hero и кладка разойдётся
       с прокруткой на всю его длину. */
